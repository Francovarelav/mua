...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: lasNubes, text: 'Las Nubes', link: 'https://www.instagram.com/mua.arq/' },
      { image: serafines, text: 'Serafines' },
      { image: gloria, text: 'Gloria' },
      { image: cartagena, text: 'Cartagena' },
      { image: quintaGolondrina, text: 'Quinta Golondrina' },
    ]
